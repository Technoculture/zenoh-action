...
class SetTree(Tree):
    def SetupTree(self):
        ...
        level3_2_1_4 = Sequence(["discard_tip_success"])
        level3_2_1_4_1 = Exception(["retry_count_below_threshold"])
        level4 = Sequence(["pickup_success"])
